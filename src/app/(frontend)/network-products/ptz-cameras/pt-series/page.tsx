...
export const metadata = {
  title: 'PT Series PTZ Cameras | Hikvision UAE',
  description: 'Pan-tilt positioning systems with flexible monitoring capabilities for comprehensive coverage',
};
...
async function fetchPTProducts() {
  try {
    ...
    console.error('Error fetching PT Series products:', error);
    return [];
  }
}

export default async function PTSeriesPage() {
  const products = await fetchPTProducts();
      ...
      <div className="container mx-auto px-4">
        <div className="mb-8">
          <div className="flex items-center mb-4">
            ...
            <h1 className="text-3xl font-bold">PT Series Positioning Systems</h1>
          </div>
          <p className="text-gray-400 max-w-3xl">
            Explore our PT Series positioning systems offering flexible pan and tilt functionality with precise control for comprehensive surveillance coverage in large areas.
          </p>
        </div>
