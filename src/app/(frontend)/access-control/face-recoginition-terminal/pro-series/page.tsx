...
export const metadata = {
  title: 'Pro Series Face Recognition Terminals | Hikvision UAE',
  description: 'Professional-grade face recognition terminals with enhanced features and reliability for demanding commercial applications',
};

async function fetchFaceRecognitionProSeriesProducts() {
  try {
    ...
    console.error('Error fetching Face Recognition Pro Series products:', error);
    return [];
  }
}

export default async function FaceRecognitionProSeriesPage() {
  const products = await fetchFaceRecognitionProSeriesProducts();
