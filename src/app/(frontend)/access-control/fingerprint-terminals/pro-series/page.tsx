...
export const metadata = {
  title: 'Pro Series Fingerprint Terminals | Hikvision UAE',
  description: 'Professional-grade fingerprint recognition terminals with advanced features for enterprise security applications',
};

async function fetchFingerprintProSeriesProducts() {
  try {
    ...
    console.error('Error fetching Fingerprint Pro Series products:', error);
    return [];
  }
}

export default async function FingerprintProSeriesPage() {
  const products = await fetchFingerprintProSeriesProducts();
      ...
      <div className="container mx-auto px-4">
        <div className="mb-8">
          <div className="flex items-center mb-4">
            ...
            <h1 className="text-3xl font-bold">Pro Series Fingerprint Terminals</h1>
          </div>
          <p className="text-gray-400 max-w-3xl">
            Discover Hikvision&apos;s Pro Series Fingerprint Terminals, designed for professional environments requiring 
            reliable biometric access control. These advanced terminals offer high recognition accuracy, fast processing 
            speeds, and enhanced durability. Perfect for corporate offices, healthcare facilities, and commercial buildings 
            requiring secure fingerprint authentication.
          </p>
        </div>
