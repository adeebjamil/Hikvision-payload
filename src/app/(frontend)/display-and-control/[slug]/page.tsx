...
export async function generateMetadata({ params }: ProductPageProps): Promise<Metadata> {
  ...
  return {
    title: `${product.title} | Hikvision UAE Display and Control`,
    description: product.meta?.description || product.description || '',
  };
}

export default async function DisplayAndControlProductDetailPage({ params }: { params: { slug: string } }) {
      ...
      <div className="border-b">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <Link href="/display-and-control" className="hover:text-red-600">Display & Control</Link>
            <span className="mx-2">/</span>
