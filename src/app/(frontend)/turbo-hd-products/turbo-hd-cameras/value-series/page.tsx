...
export const metadata = {
  title: 'Turbo HD Value Series Cameras | Hikvision UAE',
  description: 'Cost-effective Turbo HD cameras offering essential surveillance features at affordable prices',
};

async function fetchTurboHDValueProducts() {
  try {
    ...
    console.error('Error fetching Turbo HD Value Series products:', error);
    return [];
  }
}

export default async function TurboHDValueSeriesPage() {
  const products = await fetchTurboHDValueProducts();
